package com.firefly.oshe.lunli.ui.screens.MainScreenFeatures.HomePageFeatures
...
class InformationAdapterView(
    ...
    private val userCacheManager: SeparateUserCacheManager,
    private val userMessageCacheManager: MessageCacheManager,
    private val onSignOut: () -> Unit,
    private val onExitToLogin: () -> Unit,
    private val onUserImageChange: () -> Unit,
    private val onShowCropDialog: (Bitmap, (Bitmap) -> Unit) -> Unit
) {

    private val information = mutableListOf<UserInformation>()
    private var adapter: UserHomeAdapter? = null
    private var onItemClickCount = 0
    private var lastResetTime = System.currentTimeMillis()
    private lateinit var client: Client

    fun createAdapter(): UserHomeAdapter {
    ...
    inner class UserHomeAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private fun createCMLView(
        ...
        return LinearLayout(context).apply {
            ...
            ShapeableImageView(context).apply {
                layoutParams = LayoutParams(64.dp, 64.dp).apply { marginEnd = 18.dp }
                setImageBitmap(icon)
                setOnClickListener {
                    interaction.ImageRequestCallBack("HomePage") { sampleBitmap ->
                        sampleBitmap.let {
                            onShowCropDialog(it) { image ->
            ...
            LinearLayout(context).apply {
                ...
                TextView(context).apply {
                    ...
                    layoutParams = LayoutParams(WRAP_CONTENT, WRAP_CONTENT).apply { topMargin = 2.dp }
    ...
    private fun editMessageDialog(
        ...
        val input = TextInputEditText(context).apply {
            ...
            view.addView(
                it,
                LayoutParams(MATCH_PARENT, WRAP_CONTENT).apply { bottomMargin = 12.dp }
            )
        }
    ...
    private fun onEditPasswordDialog() {
        ...
        val newPasswordInput = TextInputEditText(context).apply {
            ...
            dialogView.addView(it, LayoutParams(MATCH_PARENT, WRAP_CONTENT))
        }
